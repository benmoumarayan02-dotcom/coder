...
| `»» changes`                      | array                                                                                          | false    |              | Changes lists how the pinned context differs from the agent's latest snapshot, by source. It is populated only on the single-chat GET response and only while the chat is dirty; otherwise nil.                                                                                                                                                                                                            |
...
| `»»» status`                      | [codersdk.ChatContextResourceChangeStatus](schemas.md#codersdkchatcontextresourcechangestatus) | false    |              |                                                                                                                                                                                                                                                                                                                                                                                                            |
